...
export const DEFAULT_EMAIL_AI_FRAMEWORK: Required<EmailAiFrameworkSettings> = {
  ...
  email_high_interest_segment:
    ...
    'Porta un esempio molto concreto e visivo di come funziona nella pratica (una situazione reale, passo dopo passo) invece di descrivere Speaqi in astratto o elencarne le funzionalita: per esempio “un cliente prende una vostra bottiglia, scansiona un QR e puo scoprire il vino, la cantina e il territorio nella propria lingua, attraverso testo, audio e video”. ' +
    'Cita le referenze in modo naturale, come cantine con cui state gia lavorando sullo stesso modello: per il settore vino privilegia San Salvatore 1988, Dalibra e Leonarda Tardi quando pertinenti. ' +
    ...
    'CTA: per questo segmento non chiedere una call, offri invece di mandare un esempio concreto (“Se vuoi, ti mando un esempio concreto cosi lo vedi direttamente”): deve restare una sola domanda semplice a cui sia facile rispondere, l’obiettivo e ottenere una risposta, non spiegare di nuovo il prodotto. ' +
