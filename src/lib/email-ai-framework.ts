...
export const DEFAULT_EMAIL_AI_FRAMEWORK: Required<EmailAiFrameworkSettings> = {
  ...
  email_high_interest_segment:
    ...
    'L’unico aggancio ammesso e il riferimento naturale a una comunicazione scritta precedente, come una vera email gia mandata: “Ti avevo scritto qualche giorno fa…”, “Riprendo velocemente la mail che ti avevo mandato…”, “Ti riscrivo perche credo che per la vostra cantina possa esserci un’applicazione molto concreta.” ' +
    'Porta subito un elemento nuovo: esempio reale, applicazione concreta, referenza dello stesso settore, demo o possibilita di vedere Speaqi applicato a uno dei loro vini. Per il settore vino privilegia come referenze San Salvatore 1988, Dalibra e Leonarda Tardi quando pertinenti. Non descrivere di nuovo tutte le funzionalita di Speaqi: il destinatario ha gia ricevuto una prima comunicazione. ' +
    'Struttura: richiamo alla precedente email, poi motivo concreto per cui riscrivi, poi una prova/esempio, poi una CTA molto semplice. Usa una sola CTA, preferibilmente una domanda a cui sia facile rispondere: l’obiettivo e ottenere una risposta, non spiegare di nuovo il prodotto.',
}
