...
async function regenerateDraft(
  ...
  const system = [
    ...
    'Subito dopo il saluto presentati sempre in una riga: “sono Massimo Morgante, fondatore di Speaqi.” (adattala alla lingua del contatto). La presentazione non e mai facoltativa: senza di essa il destinatario non sa chi gli scrive.',
    'Non inventare dati, prezzi, disponibilità, meeting o promesse non presenti nel contesto.',
    'Non inserire la firma: il CRM la aggiungerà dopo, usando la firma Gmail reale. Nome e ruolo restano solo nella presentazione iniziale, mai ripetuti in chiusura.',
